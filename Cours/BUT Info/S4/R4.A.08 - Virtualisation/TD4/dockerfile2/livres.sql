...
--
-- Hôte : biblio_db
-- Généré le : ven. 07 mars 2025 à 08:19
...
(6, 'Les Liaisons dangereuses (1782)', 'Choderlos de Laclos', 7, 2),
...
(10, 'Madame Bovary (1857)', 'Gustave Flaubert', 11, 3),
...
(17, 'La Nuit des temps (1968)', 'René Barjavel', 7, 3),
(18, 'La Peste (1947)', 'Albert Camus', 7, 4),
...
(29, 'L\'Assommoir (1877)', 'Émile Zola', 5, 3),
...
(34, 'Phèdre (1677)', 'Jean Racine', 4, 2),
...
(40, 'La Zone du dehors (2001)', 'Alain Damasio', 9, 4),
...
(44, 'L\'Éducation sentimentale (1869)', 'Gustave Flaubert', 11, 3),
...
(51, 'Le Tour du monde en 80 jours (1873)', 'Jules Verne', 4, 2),
...
(56, 'Les Contemplations (1856)', 'Victor Hugo', 9, 4),
...
(68, 'Paroles (1946)', 'Jacques Prévert', 11, 3),
...
(75, 'Le Rivage des Syrtes (1951)', 'Julien Gracq', 10, 4),
...
(80, 'Thérèse Raquin (1867)', 'Émile Zola', 5, 2),
...
(87, 'La Chartreuse de Parme (1839)', 'Stendhal', 7, 3),
...
(95, 'Les Particules élémentaires (1998)', 'Michel Houellebecq', 10, 3);
