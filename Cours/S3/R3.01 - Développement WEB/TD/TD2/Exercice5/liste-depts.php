...
<body>
    ...
    if (isset($nomR)) {
        createTable($nomR);
    } else if (isset($nomDept)) {
        ?>
        <ul>
            <?php
            $nom = trim($nomDept);
            foreach ($filtre_depts as $dept) {
                $nom_dept = $depts[$dept][0];

                if (strstr($nom_dept, $nom)) {
                    ?>
                    <li> <?php echo htmlentities($nom_dept) ?> </li>
                    <?php
                }
            }
            ?>
        ...
        <?php
    } else if (!isset($nomR) && !isset($nomDept)) {
